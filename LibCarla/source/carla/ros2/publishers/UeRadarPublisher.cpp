...
std::vector<sensor_msgs::msg::PointField> UeRadarPublisher::GetPointFields() const {
  ...
  descriptor5.datatype(sensor_msgs::msg::PointField_Constants::FLOAT32);
  descriptor5.count(1);
  sensor_msgs::msg::PointField descriptor6;
  descriptor6.name("altitude");
  descriptor6.offset(20);
  descriptor6.datatype(sensor_msgs::msg::PointField_Constants::FLOAT32);
  descriptor6.count(1);
  sensor_msgs::msg::PointField descriptor7;
  descriptor7.name("depth");
  descriptor7.offset(24);
  descriptor7.datatype(sensor_msgs::msg::PointField_Constants::FLOAT32);
  descriptor7.count(1);
