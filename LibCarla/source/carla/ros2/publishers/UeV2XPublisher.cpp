...
void UeV2XPublisher::UpdateSensorData(
  ...
  for (carla::sensor::data::CAMData const &cam_v2x_data : cam_v2x_data_vector) {
    ...
    carla_v2x_data.message()
        ...
        .altitude()
        .altitude_value()
        .value() = cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.altitude.altitudeValue;
    carla_v2x_data.message()
        .cam()
        .cam_parameters()
        .basic_container()
        ...
        .altitude()
        .altitude_confidence()
        .value() = cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.altitude.altitudeConfidence;
    carla_v2x_data.message().cam().cam_parameters().basic_container().reference_position().latitude().value() =
        cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.latitude;
    carla_v2x_data.message().cam().cam_parameters().basic_container().reference_position().longitude().value() =
        cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.longitude;
    carla_v2x_data.message()
        .cam()
        .cam_parameters()
        .basic_container()
        ...
        .value() = cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.positionConfidenceEllipse
                       .semiMajorConfidence;
    carla_v2x_data.message()
        .cam()
        .cam_parameters()
    ...
    carla_v2x_data.message()
        ...
        .value() = cam_v2x_data.Message.cam.camParameters.basicContainer.referencePosition.positionConfidenceEllipse
                       .semiMinorConfidence;
    carla_v2x_data.message().cam().cam_parameters().basic_container().station_type().value() =
        cam_v2x_data.Message.cam.camParameters.basicContainer.stationType;
    ...
    switch (cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.present) {
      case CAMContainer::HighFrequencyContainer_PR::HighFrequencyContainer_PR_basicVehicleContainerHighFrequency:
        carla_v2x_data.message().cam().cam_parameters().high_frequency_container().choice() =
            etsi_its_cam_msgs::msg::HighFrequencyContainer_Constants::CHOICE_BASIC_VEHICLE_CONTAINER_HIGH_FREQUENCY;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
        ...
        carla_v2x_data.message()
            ...
            .value() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .vehicleLength.vehicleLengthValue;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .acceleration_control_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                     .basicVehicleContainerHighFrequency.accelerationControlAvailable;
        ...
        carla_v2x_data.message()
            ...
            .value()
            .push_back(cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .accelerationControl);
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .lane_position_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                              .basicVehicleContainerHighFrequency.lanePositionAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .steering_wheel_angle_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                     .basicVehicleContainerHighFrequency.steeringWheelAngleAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
            ...
            .value() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .steeringWheelAngle.steeringWheelAngleValue;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .lateral_acceleration_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                     .basicVehicleContainerHighFrequency.lateralAccelerationAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .vertical_acceleration_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                      .basicVehicleContainerHighFrequency.verticalAccelerationAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .performance_class_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                  .basicVehicleContainerHighFrequency.performanceClassAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .high_frequency_container()
            .basic_vehicle_container_high_frequency()
            .cen_dsrc_tolling_zone_is_present() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer
                                                      .basicVehicleContainerHighFrequency.cenDsrcTollingZoneAvailable;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
        ...
        carla_v2x_data.message()
            ...
            .value()
            .value() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .cenDsrcTollingZone.cenDsrcTollingZoneID;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
            ...
            .value() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .cenDsrcTollingZone.protectedZoneLatitude;
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            .high_frequency_container()
            ...
            .value() = cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.basicVehicleContainerHighFrequency
                           .cenDsrcTollingZone.protectedZoneLongitude;
        break;
      case CAMContainer::HighFrequencyContainer_PR::HighFrequencyContainer_PR_rsuContainerHighFrequency:
        ...
        carla_v2x_data.message()
            ...
            cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.rsuContainerHighFrequency
                .protectedCommunicationZonesRSU.ProtectedCommunicationZoneCount > 0u;
        for (auto i = 0u; i < cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.rsuContainerHighFrequency
                                  .protectedCommunicationZonesRSU.ProtectedCommunicationZoneCount;
             ++i) {
          auto const &protectedCommunicationZoneRSU =
              cam_v2x_data.Message.cam.camParameters.highFrequencyContainer.rsuContainerHighFrequency
                  .protectedCommunicationZonesRSU.data[i];
          ...
          protectedCommunicationZone.protected_zone_id_is_present() =
              protectedCommunicationZoneRSU.protectedZoneIDAvailable;
          protectedCommunicationZone.protected_zone_id().value() = protectedCommunicationZoneRSU.protectedZoneID;
          protectedCommunicationZone.protected_zone_latitude().value() =
              protectedCommunicationZoneRSU.protectedZoneLatitude;
          protectedCommunicationZone.protected_zone_longitude().value() =
              protectedCommunicationZoneRSU.protectedZoneLongitude;
          protectedCommunicationZone.protected_zone_radius_is_present() =
              protectedCommunicationZoneRSU.protectedZoneRadiusAvailable;
          protectedCommunicationZone.protected_zone_radius().value() =
              protectedCommunicationZoneRSU.protectedZoneRadius;
          ...
          carla_v2x_data.message()
              ...
              .array()
              .push_back(protectedCommunicationZone);
        }
        break;
      case CAMContainer::HighFrequencyContainer_PR::HighFrequencyContainer_PR_NOTHING:
        // theorectically must not happen, since in the protocol Nothing is not defined and is translated into
        // high_fequency_container_is_present, which is also not defined by the actual protocol!
        carla_v2x_data.message().cam().cam_parameters().high_frequency_container().choice() =
            etsi_its_cam_msgs::msg::HighFrequencyContainer_Constants::CHOICE_BASIC_VEHICLE_CONTAINER_HIGH_FREQUENCY;
        break;
    }
    ...
    switch (cam_v2x_data.Message.cam.camParameters.lowFrequencyContainer.present) {
      ...
      case CAMContainer::LowFrequencyContainer_PR::LowFrequencyContainer_PR_basicVehicleContainerLowFrequency:
        ...
        carla_v2x_data.message().cam().cam_parameters().low_frequency_container().choice() =
            etsi_its_cam_msgs::msg::LowFrequencyContainer_Constants::CHOICE_BASIC_VEHICLE_CONTAINER_LOW_FREQUENCY;
        // TODO: carla implemenation differs from CAM definition, since ASN.1 defines a list
        carla_v2x_data.message()
            .cam()
            .cam_parameters()
            ...
            .exterior_lights()
            .value()
            .push_back(cam_v2x_data.Message.cam.camParameters.lowFrequencyContainer.basicVehicleContainerLowFrequency
                           .exteriorLights);
        for (auto i = 0u; i < cam_v2x_data.Message.cam.camParameters.lowFrequencyContainer
                                  .basicVehicleContainerLowFrequency.pathHistory.NumberOfPathPoint;
             ++i) {
          auto const &pathPointCarla = cam_v2x_data.Message.cam.camParameters.lowFrequencyContainer
                                           .basicVehicleContainerLowFrequency.pathHistory.data[i];
        ...
        carla_v2x_data.message()
            ...
            .vehicle_role()
            .value() =
            cam_v2x_data.Message.cam.camParameters.lowFrequencyContainer.basicVehicleContainerLowFrequency.vehicleRole;
    }
