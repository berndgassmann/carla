    ...
    namespace msg {
        ...
        ClockPubSubType::ClockPubSubType()
        {
            ...
            uint32_t type_size =
                ...
                static_cast<uint32_t>(Clock::getMaxCdrSerializedSize());
        #else
                rosgraph_msgs_msg_Clock_max_cdr_typesize;
        #endif
            type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
            m_typeSize = type_size + 4; /*encapsulation*/
            m_isGetKeyDefined = false;
            uint32_t keyLength = rosgraph_msgs_msg_Clock_max_key_cdr_typesize > 16 ? rosgraph_msgs_msg_Clock_max_key_cdr_typesize : 16;
            ...
            return [data, data_representation]() -> uint32_t
                   {
                       ...
                       try
                       {
                           ...
                           return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                       *static_cast<Clock*>(data), current_alignment)) +
                                   4u /*encapsulation*/;
                       }
                       catch (eprosima::fastcdr::exception::Exception& /*exception*/)
                       {
