...
public:
   ...
   */
  eProsima_user_DllExport AckermannDrive(const AckermannDrive& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object ackermann_msgs::msg::AckermannDrive that will be copied.
   */
  eProsima_user_DllExport AckermannDrive(AckermannDrive&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object ackermann_msgs::msg::AckermannDrive that will be copied.
   */
  eProsima_user_DllExport AckermannDrive& operator=(const AckermannDrive& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object ackermann_msgs::msg::AckermannDrive that will be copied.
   */
  eProsima_user_DllExport AckermannDrive& operator=(AckermannDrive&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x ackermann_msgs::msg::AckermannDrive object to compare.
   */
  eProsima_user_DllExport bool operator==(const AckermannDrive& x) const;
   ...
   */
  eProsima_user_DllExport void steering_angle(float _steering_angle);
   ...
   */
  eProsima_user_DllExport void steering_angle_velocity(float _steering_angle_velocity);
   ...
   */
  eProsima_user_DllExport void acceleration(float _acceleration);
   ...
   */
  eProsima_user_DllExport void jerk(float _jerk);
