...
public:
   ...
   */
  eProsima_user_DllExport BasicVehicleContainerLowFrequency(const BasicVehicleContainerLowFrequency& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object etsi_its_cam_msgs::msg::BasicVehicleContainerLowFrequency that will be copied.
   */
  eProsima_user_DllExport BasicVehicleContainerLowFrequency(BasicVehicleContainerLowFrequency&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object etsi_its_cam_msgs::msg::BasicVehicleContainerLowFrequency that will be copied.
   */
  eProsima_user_DllExport BasicVehicleContainerLowFrequency& operator=(const BasicVehicleContainerLowFrequency& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object etsi_its_cam_msgs::msg::BasicVehicleContainerLowFrequency that will be copied.
   */
  eProsima_user_DllExport BasicVehicleContainerLowFrequency& operator=(BasicVehicleContainerLowFrequency&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x etsi_its_cam_msgs::msg::BasicVehicleContainerLowFrequency object to compare.
   */
  eProsima_user_DllExport bool operator==(const BasicVehicleContainerLowFrequency& x) const;
   ...
   */
  eProsima_user_DllExport void vehicle_role(const etsi_its_cam_msgs::msg::VehicleRole& _vehicle_role);
   ...
   */
  eProsima_user_DllExport void vehicle_role(etsi_its_cam_msgs::msg::VehicleRole&& _vehicle_role);
   ...
   */
  eProsima_user_DllExport void exterior_lights(const etsi_its_cam_msgs::msg::ExteriorLights& _exterior_lights);
   ...
   */
  eProsima_user_DllExport void exterior_lights(etsi_its_cam_msgs::msg::ExteriorLights&& _exterior_lights);
   ...
   */
  eProsima_user_DllExport void path_history(const etsi_its_cam_msgs::msg::PathHistory& _path_history);
   ...
   */
  eProsima_user_DllExport void path_history(etsi_its_cam_msgs::msg::PathHistory&& _path_history);
