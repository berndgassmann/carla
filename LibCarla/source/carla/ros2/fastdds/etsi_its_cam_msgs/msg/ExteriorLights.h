...
public:
   ...
   */
  eProsima_user_DllExport ExteriorLights(const ExteriorLights& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object etsi_its_cam_msgs::msg::ExteriorLights that will be copied.
   */
  eProsima_user_DllExport ExteriorLights(ExteriorLights&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object etsi_its_cam_msgs::msg::ExteriorLights that will be copied.
   */
  eProsima_user_DllExport ExteriorLights& operator=(const ExteriorLights& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object etsi_its_cam_msgs::msg::ExteriorLights that will be copied.
   */
  eProsima_user_DllExport ExteriorLights& operator=(ExteriorLights&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x etsi_its_cam_msgs::msg::ExteriorLights object to compare.
   */
  eProsima_user_DllExport bool operator==(const ExteriorLights& x) const;
