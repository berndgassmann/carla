...
#error Generated CAM is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
...
#endif  // _FAST_DDS_GENERATED_ETSI_ITS_CAM_MSGS_MSG_CAM_PUBSUBTYPES_H_
