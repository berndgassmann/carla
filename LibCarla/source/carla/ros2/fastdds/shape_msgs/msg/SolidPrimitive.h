...
public:
   ...
   */
  eProsima_user_DllExport SolidPrimitive(const SolidPrimitive& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object shape_msgs::msg::SolidPrimitive that will be copied.
   */
  eProsima_user_DllExport SolidPrimitive(SolidPrimitive&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object shape_msgs::msg::SolidPrimitive that will be copied.
   */
  eProsima_user_DllExport SolidPrimitive& operator=(const SolidPrimitive& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object shape_msgs::msg::SolidPrimitive that will be copied.
   */
  eProsima_user_DllExport SolidPrimitive& operator=(SolidPrimitive&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x shape_msgs::msg::SolidPrimitive object to compare.
   */
  eProsima_user_DllExport bool operator==(const SolidPrimitive& x) const;
