...
public:
   ...
   */
  eProsima_user_DllExport void position_covariance(const sensor_msgs::msg::double__9& _position_covariance);
   ...
   */
  eProsima_user_DllExport void position_covariance(sensor_msgs::msg::double__9&& _position_covariance);
