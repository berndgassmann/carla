...
public:
   ...
   */
  eProsima_user_DllExport void orientation_covariance(const sensor_msgs::msg::double__9& _orientation_covariance);
   ...
   */
  eProsima_user_DllExport void orientation_covariance(sensor_msgs::msg::double__9&& _orientation_covariance);
   ...
   */
  eProsima_user_DllExport void angular_velocity_covariance(sensor_msgs::msg::double__9&& _angular_velocity_covariance);
