...
public:
   ...
   */
  eProsima_user_DllExport void covariance(const geometry_msgs::msg::double__36& _covariance);

  /*!
   * @brief This function moves the value in member covariance
   * @param _covariance New value to be moved in member covariance
   */
  eProsima_user_DllExport void covariance(geometry_msgs::msg::double__36&& _covariance);
