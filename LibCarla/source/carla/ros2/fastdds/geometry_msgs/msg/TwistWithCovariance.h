...
typedef std::array<double, 36> __double__36;
...
public:
   ...
   */
  eProsima_user_DllExport void covariance(const geometry_msgs::msg::__double__36& _covariance);

  /*!
   * @brief This function moves the value in member covariance
   * @param _covariance New value to be moved in member covariance
   */
  eProsima_user_DllExport void covariance(geometry_msgs::msg::__double__36&& _covariance);

  /*!
   * @brief This function returns a constant reference to member covariance
   * @return Constant reference to member covariance
   */
  eProsima_user_DllExport const geometry_msgs::msg::__double__36& covariance() const;

  /*!
   * @brief This function returns a reference to member covariance
   * @return Reference to member covariance
   */
  eProsima_user_DllExport geometry_msgs::msg::__double__36& covariance();

private:
  geometry_msgs::msg::Twist m_twist;
  geometry_msgs::msg::__double__36 m_covariance{0.0};
};
