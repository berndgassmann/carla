...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(CARLAVEHICLECONTROL_SOURCE)
#define CARLAVEHICLECONTROL_DllAPI __declspec(dllexport)
#else
#define CARLAVEHICLECONTROL_DllAPI __declspec(dllimport)
#endif  // CARLAVEHICLECONTROL_SOURCE
#else
#define CARLAVEHICLECONTROL_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define CARLAVEHICLECONTROL_DllAPI
#endif  // _WIN32
...
/*!
 * @brief This class represents the structure CarlaVehicleControl defined by the user in the IDL file.
 * @ingroup CarlaVehicleControl
 */
...
public:
   ...
   */
  eProsima_user_DllExport CarlaVehicleControl();
   ...
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl(const CarlaVehicleControl& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl(CarlaVehicleControl&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl& operator=(const CarlaVehicleControl& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaVehicleControl that will be copied.
   */
  eProsima_user_DllExport CarlaVehicleControl& operator=(CarlaVehicleControl&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x carla_msgs::msg::CarlaVehicleControl object to compare.
   */
  eProsima_user_DllExport bool operator==(const CarlaVehicleControl& x) const;
   ...
   */
  eProsima_user_DllExport void control_priority(uint8_t _control_priority);
...
#endif  // _FAST_DDS_GENERATED_CARLA_MSGS_MSG_CARLAVEHICLECONTROL_H_
