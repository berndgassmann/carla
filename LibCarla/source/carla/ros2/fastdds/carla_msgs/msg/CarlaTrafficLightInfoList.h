...
public:
   ...
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList(const CarlaTrafficLightInfoList& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfoList that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList(CarlaTrafficLightInfoList&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfoList that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList& operator=(const CarlaTrafficLightInfoList& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaTrafficLightInfoList that will be copied.
   */
  eProsima_user_DllExport CarlaTrafficLightInfoList& operator=(CarlaTrafficLightInfoList&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x carla_msgs::msg::CarlaTrafficLightInfoList object to compare.
   */
  eProsima_user_DllExport bool operator==(const CarlaTrafficLightInfoList& x) const;
   ...
   */
  eProsima_user_DllExport void traffic_lights(std::vector<carla_msgs::msg::CarlaTrafficLightInfo>&& _traffic_lights);
