...
public:
   ...
   */
  eProsima_user_DllExport CarlaEpisodeSettings(const CarlaEpisodeSettings& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object carla_msgs::msg::CarlaEpisodeSettings that will be copied.
   */
  eProsima_user_DllExport CarlaEpisodeSettings(CarlaEpisodeSettings&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaEpisodeSettings that will be copied.
   */
  eProsima_user_DllExport CarlaEpisodeSettings& operator=(const CarlaEpisodeSettings& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object carla_msgs::msg::CarlaEpisodeSettings that will be copied.
   */
  eProsima_user_DllExport CarlaEpisodeSettings& operator=(CarlaEpisodeSettings&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x carla_msgs::msg::CarlaEpisodeSettings object to compare.
   */
  eProsima_user_DllExport bool operator==(const CarlaEpisodeSettings& x) const;
   ...
   */
  eProsima_user_DllExport void no_rendering_mode(bool _no_rendering_mode);
   ...
   */
  eProsima_user_DllExport void fixed_delta_seconds(double _fixed_delta_seconds);
   ...
   */
  eProsima_user_DllExport void substepping(bool _substepping);
   ...
   */
  eProsima_user_DllExport void max_substep_delta_time(double _max_substep_delta_time);
   ...
   */
  eProsima_user_DllExport void max_substeps(int32_t _max_substeps);
   ...
   */
  eProsima_user_DllExport void max_culling_distance(float _max_culling_distance);
   ...
   */
  eProsima_user_DllExport void deterministic_ragdolls(bool _deterministic_ragdolls);
   ...
   */
  eProsima_user_DllExport void tile_stream_distance(float _tile_stream_distance);
   ...
   */
  eProsima_user_DllExport void actor_active_distance(float _actor_active_distance);
   ...
   */
  eProsima_user_DllExport void spectator_as_ego(bool _spectator_as_ego);
