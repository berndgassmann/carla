...
public:
   ...
   * @param x Reference to the object carla_msgs::srv::DestroyObject_Request that will be copied.
   */
  eProsima_user_DllExport DestroyObject_Request(DestroyObject_Request&& x) noexcept;
   ...
   * @param x Reference to the object carla_msgs::srv::DestroyObject_Request that will be copied.
   */
  eProsima_user_DllExport DestroyObject_Request& operator=(DestroyObject_Request&& x) noexcept;
...
public:
   ...
   * @param x Reference to the object carla_msgs::srv::DestroyObject_Response that will be copied.
   */
  eProsima_user_DllExport DestroyObject_Response(DestroyObject_Response&& x) noexcept;
   ...
   * @param x Reference to the object carla_msgs::srv::DestroyObject_Response that will be copied.
   */
  eProsima_user_DllExport DestroyObject_Response& operator=(DestroyObject_Response&& x) noexcept;
