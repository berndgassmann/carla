...
public:
   ...
   * @param x Reference to the object carla_msgs::srv::GetBlueprints_Request that will be copied.
   */
  eProsima_user_DllExport GetBlueprints_Request(GetBlueprints_Request&& x) noexcept;
   ...
   * @param x Reference to the object carla_msgs::srv::GetBlueprints_Request that will be copied.
   */
  eProsima_user_DllExport GetBlueprints_Request& operator=(GetBlueprints_Request&& x) noexcept;
...
public:
   ...
   * @param x Reference to the object carla_msgs::srv::GetBlueprints_Response that will be copied.
   */
  eProsima_user_DllExport GetBlueprints_Response(GetBlueprints_Response&& x) noexcept;
   ...
   * @param x Reference to the object carla_msgs::srv::GetBlueprints_Response that will be copied.
   */
  eProsima_user_DllExport GetBlueprints_Response& operator=(GetBlueprints_Response&& x) noexcept;
   ...
   */
  eProsima_user_DllExport void blueprints(const std::vector<carla_msgs::msg::CarlaActorBlueprint>& _blueprints);

  /*!
   * @brief This function moves the value in member blueprints
   * @param _blueprints New value to be moved in member blueprints
   */
  eProsima_user_DllExport void blueprints(std::vector<carla_msgs::msg::CarlaActorBlueprint>&& _blueprints);
