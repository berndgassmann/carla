...
/*!
 * @brief This class offers an interface to serialize/deserialize some basic types using CDR protocol inside an
...
public:
   ...
   */
  Cdr_DllAPI Cdr(FastBuffer& cdr_buffer, const Endianness endianness = DEFAULT_ENDIAN,
                 const CdrVersion cdr_version = XCDRv2);

  /*!
   * @brief This function reads the encapsulation of the CDR stream.
   *        If the CDR stream contains an encapsulation, then this function should be called before starting to
   * deserialize. CdrVersion and EncodingAlgorithmFlag internal values will be changed to the ones specified by the
   *        encapsulation.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown when trying to deserialize a position that
   * exceeds the internal memory size.
   ...
   *        If the CDR stream should contain an encapsulation, then this function should be called before starting to
   * serialize.
   * @return Reference to the eprosima::fastcdr::Cdr object.
   * @exception exception::NotEnoughMemoryException This exception is thrown when trying to serialize a position that
   * exceeds the internal memory size.
   */
   ...
   */
  inline static size_t alignment(size_t current_alignment, size_t data_size) {
   ...
   */
  template <class _T>
  inline Cdr& operator<<(const _T& value) {
   ...
   */
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, int32_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, uint32_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, int16_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, uint16_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, int8_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <
      class _T, typename std::enable_if<std::is_enum<_T>::value>::type* = nullptr,
      typename std::enable_if<std::is_same<typename std::underlying_type<_T>::type, uint8_t>::value>::type* = nullptr>
  Cdr& serialize(const _T& value) {
  ...
  template <class _T, class _Alloc,
            typename std::enable_if<!std::is_enum<_T>::value && !std::is_arithmetic<_T>::value>::type* = nullptr>
  Cdr& serialize(const std::vector<_T, _Alloc>& vector_t) {
    Cdr::state dheader_state{allocate_xcdrv2_dheader()};
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const uint8_t* octet_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const int8_t* int8, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const uint16_t* ushort_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const uint32_t* ulong_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const uint64_t* ulonglong_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const std::string* string_t, size_t num_elements) {
    for (size_t count = 0; count < num_elements; ++count) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const std::wstring* string_t, size_t num_elements) {
    for (size_t count = 0; count < num_elements; ++count) {
      serialize(string_t[count].c_str());
    }
    return *this;
  ...
  template <class _T, class _Alloc,
            typename std::enable_if<std::is_enum<_T>::value || std::is_arithmetic<_T>::value>::type* = nullptr>
  Cdr& serialize_array(const std::vector<_T, _Alloc>& value) {
   ...
   */
  template <class _T, class _Alloc>
  Cdr& serialize_array(const std::vector<_T, _Alloc>& value, Endianness endianness) {
    bool aux_swap = swap_bytes_;
    swap_bytes_ = (swap_bytes_ && (static_cast<Endianness>(endianness_) == endianness)) ||
                  (!swap_bytes_ && (static_cast<Endianness>(endianness_) != endianness));
   ...
   */
  TEMPLATE_SPEC
  Cdr& serialize_array(const std::vector<bool>& value) {
   ...
   * This function allocates memory to store the wide string. The user pointer will be set to point this allocated
   * memory. The user will have to free this allocated memory using free()
  ...
  template <class _T, class _Alloc,
            typename std::enable_if<!std::is_enum<_T>::value && !std::is_arithmetic<_T>::value>::type* = nullptr>
  Cdr& deserialize(std::vector<_T, _Alloc>& vector_t) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(uint8_t* octet_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(int8_t* int8, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(uint16_t* ushort_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(uint32_t* ulong_t, size_t num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(uint64_t* ulonglong_t, size_t num_elements) {
  ...
  template <class _T, class _Alloc,
            typename std::enable_if<std::is_enum<_T>::value || std::is_arithmetic<_T>::value>::type* = nullptr>
  Cdr& deserialize_array(std::vector<_T, _Alloc>& value) {
   ...
   */
  template <class _T, class _Alloc>
  Cdr& deserialize_array(std::vector<_T, _Alloc>& value, Endianness endianness) {
    bool aux_swap = swap_bytes_;
    swap_bytes_ = (swap_bytes_ && (static_cast<Endianness>(endianness_) == endianness)) ||
                  (!swap_bytes_ && (static_cast<Endianness>(endianness_) != endianness));
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_array(std::vector<bool>& value) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_sequence(std::string*& sequence_t, size_t& num_elements) {
   ...
   */
  TEMPLATE_SPEC
  Cdr& deserialize_sequence(std::wstring*& sequence_t, size_t& num_elements) {
   ...
   */
  template <class _T>
  Cdr& serialize_member(const MemberId& member_id, const _T& member_value,
   ...
   */
  template <class _T>
  Cdr& serialize_member(const MemberId& member_id, const optional<_T>& member_value,
                        XCdrHeaderSelection header_selection = XCdrHeaderSelection::AUTO_WITH_SHORT_HEADER_BY_DEFAULT) {
    Cdr::state current_state(*this);
...
private:
  ...
  /*!
   * @brief This function template detects the content type of STD container array and deserializes the array with a
  ...
  /*!
   * @brief This function jumps the number of bytes of the alignment. These bytes should be calculated with the function
   * eprosima::fastcdr::Cdr::alignment.
   * @param align The number of bytes to be skipped.
   */
  inline void make_alignment(size_t align) {
    offset_ += align;
    last_data_size_ = 0;
  }

  /*!
   * @brief This function resizes the internal buffer. It only applies if the FastBuffer object was created with the
   * default constructor.
   ...
   */
  Cdr& xcdr1_begin_serialize_member(const MemberId& member_id, bool is_present, Cdr::state& current_state,
   ...
   * header_selection is XCdrHeaderSelection::SHORT_HEADER.
   */
  Cdr& xcdr1_begin_serialize_opt_member(const MemberId& member_id, bool is_present, Cdr::state& current_state,
                                        XCdrHeaderSelection header_selection);
   ...
   */
  Cdr& xcdr2_begin_serialize_member(const MemberId& member_id, bool is_present, Cdr::state& current_state,
                                    XCdrHeaderSelection header_selection);
  ...
  Cdr& cdr_begin_serialize_member(const MemberId& member_id, bool is_present, Cdr::state& current_state,
                                  XCdrHeaderSelection header_selection);
