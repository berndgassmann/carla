...
public:
   ...
   */
  eProsima_user_DllExport ObjectArray(const ObjectArray& x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object derived_object_msgs::msg::ObjectArray that will be copied.
   */
  eProsima_user_DllExport ObjectArray(ObjectArray&& x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object derived_object_msgs::msg::ObjectArray that will be copied.
   */
  eProsima_user_DllExport ObjectArray& operator=(const ObjectArray& x);

  /*!
   * @brief Move assignment.
   * @param x Reference to the object derived_object_msgs::msg::ObjectArray that will be copied.
   */
  eProsima_user_DllExport ObjectArray& operator=(ObjectArray&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x derived_object_msgs::msg::ObjectArray object to compare.
   */
  eProsima_user_DllExport bool operator==(const ObjectArray& x) const;
   ...
   */
  eProsima_user_DllExport void objects(const std::vector<derived_object_msgs::msg::Object>& _objects);

  /*!
   * @brief This function moves the value in member objects
   * @param _objects New value to be moved in member objects
   */
  eProsima_user_DllExport void objects(std::vector<derived_object_msgs::msg::Object>&& _objects);
